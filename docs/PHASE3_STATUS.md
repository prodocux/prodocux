...
and compare/evidence UI — those remain Farpals-owned slices.
...
Engine job-bound hop: `POST /internal/v1/jobs/{job_id}/retrieve`.
See `pdx-artifact-engine/docs/PHASE3_STATUS.md`.
